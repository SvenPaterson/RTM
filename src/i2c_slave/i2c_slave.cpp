...
Registers registers;
I2CRegisterSlave motor_board = I2CRegisterSlave(Slave, (uint8_t*)&settings, sizeof(Settings), (uint8_t*)&registers, sizeof(Registers));
...
void setup() {
    ...
    // Start listening
    motor_board.listen(0x40);
    motor_board.after_read(on_read_isr);
